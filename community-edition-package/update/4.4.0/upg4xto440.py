...
class GluuUpdater:
    def __init__(self):
        ...
        self.jetty_version = '9.4.46.v20220331'
...
#./makeself.sh --target /opt/upd/4.4.0 /opt/upd/4.4.0 4-4-0.rc1-upg.run "Gluu Server 4.x to 4.4.0 Upgrader Script" /opt/upd/4.4.0/upg4xto440.py --offline
